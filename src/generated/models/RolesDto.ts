...
export function RolesDtoFromJSONTyped(json: any, _ignoreDiscriminator: boolean): RolesDto {
    if (json == null) {
        return json;
    }
    return {
...
export function RolesDtoToJSON(value?: RolesDto | null, _ignoreDiscriminator = false): any {
    if (value == null) {
        return value;
    }
    return {
