...
export function FieldPropertiesDtoFromJSONTyped(json: any, ignoreDiscriminator: boolean): FieldPropertiesDto {
    if (json == null) {
        return json;
    }
...
export function FieldPropertiesDtoToJSON(value?: FieldPropertiesDto | null, ignoreDiscriminator = false): any {
    if (value == null) {
        return value;
    }
    if (!ignoreDiscriminator) {
