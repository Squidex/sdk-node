...
export function ElasticSearchRuleActionDtoFromJSONTyped(json: any, _ignoreDiscriminator: boolean): ElasticSearchRuleActionDto {
    if (json == null) {
        return json;
    }
    return {
...
export function ElasticSearchRuleActionDtoToJSON(value?: ElasticSearchRuleActionDto | null, _ignoreDiscriminator = false): any {
    if (value == null) {
        return value;
    }
    return {
