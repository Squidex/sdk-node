...
export function UpdateWorkflowDtoFromJSONTyped(json: any, _ignoreDiscriminator: boolean): UpdateWorkflowDto {
    if (json == null) {
        return json;
    }
    return {
...
export function UpdateWorkflowDtoToJSON(value?: UpdateWorkflowDto | null, _ignoreDiscriminator = false): any {
    if (value == null) {
        return value;
    }
    return {
