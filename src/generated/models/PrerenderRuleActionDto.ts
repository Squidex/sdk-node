...
export function PrerenderRuleActionDtoFromJSONTyped(json: any, ignoreDiscriminator: boolean): PrerenderRuleActionDto {
    if (json == null) {
        return json;
    }
    return {
...
export function PrerenderRuleActionDtoToJSON(value?: PrerenderRuleActionDto | null, ignoreDiscriminator = false): any {
    if (value == null) {
        return value;
    }
    return {
