...
export function SchemaScriptsDtoFromJSONTyped(json: any, _ignoreDiscriminator: boolean): SchemaScriptsDto {
    if (json == null) {
        return json;
    }
    return {
...
export function SchemaScriptsDtoToJSON(value?: SchemaScriptsDto | null, _ignoreDiscriminator = false): any {
    if (value == null) {
        return value;
    }
    return {
