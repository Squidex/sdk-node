...
export function SchemaConditionFromJSONTyped(json: any, _ignoreDiscriminator: boolean): SchemaCondition {
    if (json == null) {
        return json;
    }
    return {
...
export function SchemaConditionToJSON(value?: SchemaCondition | null, _ignoreDiscriminator = false): any {
    if (value == null) {
        return value;
    }
    return {
