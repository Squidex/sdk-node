...
export function RuleActionDtoFromJSONTyped(json: any, _ignoreDiscriminator: boolean): RuleActionDto {
    if (json == null) {
        return json;
    }
...
export function RuleActionDtoToJSON(value?: RuleActionDto | null, _ignoreDiscriminator = false): any {
    if (value == null) {
        return value;
    }
    if (!_ignoreDiscriminator) {
