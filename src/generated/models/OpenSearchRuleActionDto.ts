...
export function OpenSearchRuleActionDtoFromJSONTyped(json: any, ignoreDiscriminator: boolean): OpenSearchRuleActionDto {
    if (json == null) {
        return json;
    }
    return {
...
export function OpenSearchRuleActionDtoToJSON(value?: OpenSearchRuleActionDto | null, ignoreDiscriminator = false): any {
    if (value == null) {
        return value;
    }
    return {
