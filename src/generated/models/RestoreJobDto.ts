...
export function RestoreJobDtoFromJSONTyped(json: any, _ignoreDiscriminator: boolean): RestoreJobDto {
    if (json == null) {
        return json;
    }
    return {
...
export function RestoreJobDtoToJSON(value?: RestoreJobDto | null, _ignoreDiscriminator = false): any {
    if (value == null) {
        return value;
    }
    return {
