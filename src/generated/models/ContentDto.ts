...
export function ContentDtoFromJSONTyped(json: any, _ignoreDiscriminator: boolean): ContentDto {
    if (json == null) {
        return json;
    }
    return {
...
export function ContentDtoToJSON(value?: ContentDto | null, _ignoreDiscriminator = false): any {
    if (value == null) {
        return value;
    }
    return {
