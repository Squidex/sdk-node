...
export function ClientDtoFromJSONTyped(json: any, _ignoreDiscriminator: boolean): ClientDto {
    if (json == null) {
        return json;
    }
    return {
...
export function ClientDtoToJSON(value?: ClientDto | null, _ignoreDiscriminator = false): any {
    if (value == null) {
        return value;
    }
    return {
