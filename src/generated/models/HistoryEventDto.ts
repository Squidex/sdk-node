...
export function HistoryEventDtoFromJSONTyped(json: any, _ignoreDiscriminator: boolean): HistoryEventDto {
    if (json == null) {
        return json;
    }
    return {
...
export function HistoryEventDtoToJSON(value?: HistoryEventDto | null, _ignoreDiscriminator = false): any {
    if (value == null) {
        return value;
    }
    return {
