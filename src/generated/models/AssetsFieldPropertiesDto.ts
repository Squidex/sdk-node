...
export function AssetsFieldPropertiesDtoFromJSONTyped(json: any, _ignoreDiscriminator: boolean): AssetsFieldPropertiesDto {
    if (json == null) {
        return json;
    }
    return {
...
export function AssetsFieldPropertiesDtoToJSON(value?: AssetsFieldPropertiesDto | null, _ignoreDiscriminator = false): any {
    if (value == null) {
        return value;
    }
    return {
