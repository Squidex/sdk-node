...
export function RuleDtoFromJSONTyped(json: any, _ignoreDiscriminator: boolean): RuleDto {
    if (json == null) {
        return json;
    }
    return {
...
export function RuleDtoToJSON(value?: RuleDto | null, _ignoreDiscriminator = false): any {
    if (value == null) {
        return value;
    }
    return {
