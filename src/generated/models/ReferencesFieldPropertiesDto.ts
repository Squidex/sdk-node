...
export function ReferencesFieldPropertiesDtoFromJSONTyped(json: any, _ignoreDiscriminator: boolean): ReferencesFieldPropertiesDto {
    if (json == null) {
        return json;
    }
    return {
...
export function ReferencesFieldPropertiesDtoToJSON(value?: ReferencesFieldPropertiesDto | null, _ignoreDiscriminator = false): any {
    if (value == null) {
        return value;
    }
    return {
