...
export function UpsertSchemaNestedFieldDtoFromJSONTyped(json: any, _ignoreDiscriminator: boolean): UpsertSchemaNestedFieldDto {
    if (json == null) {
        return json;
    }
    return {
...
export function UpsertSchemaNestedFieldDtoToJSON(value?: UpsertSchemaNestedFieldDto | null, _ignoreDiscriminator = false): any {
    if (value == null) {
        return value;
    }
    return {
