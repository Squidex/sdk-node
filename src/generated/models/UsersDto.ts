...
export function UsersDtoFromJSONTyped(json: any, _ignoreDiscriminator: boolean): UsersDto {
    if (json == null) {
        return json;
    }
    return {
...
export function UsersDtoToJSON(value?: UsersDto | null, _ignoreDiscriminator = false): any {
    if (value == null) {
        return value;
    }
    return {
