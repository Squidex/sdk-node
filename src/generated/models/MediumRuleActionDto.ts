...
export function MediumRuleActionDtoFromJSONTyped(json: any, ignoreDiscriminator: boolean): MediumRuleActionDto {
    if (json == null) {
        return json;
    }
    return {
...
export function MediumRuleActionDtoToJSON(value?: MediumRuleActionDto | null, ignoreDiscriminator = false): any {
    if (value == null) {
        return value;
    }
    return {
