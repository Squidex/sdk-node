...
export function NestedFieldDtoFromJSONTyped(json: any, _ignoreDiscriminator: boolean): NestedFieldDto {
    if (json == null) {
        return json;
    }
    return {
...
export function NestedFieldDtoToJSON(value?: NestedFieldDto | null, _ignoreDiscriminator = false): any {
    if (value == null) {
        return value;
    }
    return {
