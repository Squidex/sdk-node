...
export function AssetFolderDtoFromJSONTyped(json: any, _ignoreDiscriminator: boolean): AssetFolderDto {
    if (json == null) {
        return json;
    }
    return {
...
export function AssetFolderDtoToJSON(value?: AssetFolderDto | null, _ignoreDiscriminator = false): any {
    if (value == null) {
        return value;
    }
    return {
