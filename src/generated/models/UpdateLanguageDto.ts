...
export function UpdateLanguageDtoFromJSONTyped(json: any, ignoreDiscriminator: boolean): UpdateLanguageDto {
    if (json == null) {
        return json;
    }
    return {
...
export function UpdateLanguageDtoToJSON(value?: UpdateLanguageDto | null, ignoreDiscriminator = false): any {
    if (value == null) {
        return value;
    }
    return {
