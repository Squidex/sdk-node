...
export function AzureQueueRuleActionDtoFromJSONTyped(json: any, _ignoreDiscriminator: boolean): AzureQueueRuleActionDto {
    if (json == null) {
        return json;
    }
    return {
...
export function AzureQueueRuleActionDtoToJSON(value?: AzureQueueRuleActionDto | null, _ignoreDiscriminator = false): any {
    if (value == null) {
        return value;
    }
    return {
