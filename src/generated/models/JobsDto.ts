...
export function JobsDtoFromJSONTyped(json: any, _ignoreDiscriminator: boolean): JobsDto {
    if (json == null) {
        return json;
    }
    return {
...
export function JobsDtoToJSON(value?: JobsDto | null, _ignoreDiscriminator = false): any {
    if (value == null) {
        return value;
    }
    return {
