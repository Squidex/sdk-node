...
export function UpsertSchemaDtoFromJSONTyped(json: any, _ignoreDiscriminator: boolean): UpsertSchemaDto {
    if (json == null) {
        return json;
    }
    return {
...
export function UpsertSchemaDtoToJSON(value?: UpsertSchemaDto | null, _ignoreDiscriminator = false): any {
    if (value == null) {
        return value;
    }
    return {
