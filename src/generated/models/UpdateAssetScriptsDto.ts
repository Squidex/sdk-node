...
export function UpdateAssetScriptsDtoFromJSONTyped(json: any, _ignoreDiscriminator: boolean): UpdateAssetScriptsDto {
    if (json == null) {
        return json;
    }
    return {
...
export function UpdateAssetScriptsDtoToJSON(value?: UpdateAssetScriptsDto | null, _ignoreDiscriminator = false): any {
    if (value == null) {
        return value;
    }
    return {
