...
export function SortNodeFromJSONTyped(json: any, _ignoreDiscriminator: boolean): SortNode {
    if (json == null) {
        return json;
    }
    return {
...
export function SortNodeToJSON(value?: SortNode | null, _ignoreDiscriminator = false): any {
    if (value == null) {
        return value;
    }
    return {
