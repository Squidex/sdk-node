...
export function AddFieldDtoFromJSONTyped(json: any, ignoreDiscriminator: boolean): AddFieldDto {
    if (json == null) {
        return json;
    }
    return {
...
export function AddFieldDtoToJSON(value?: AddFieldDto | null, ignoreDiscriminator = false): any {
    if (value == null) {
        return value;
    }
    return {
