...
export function UpdateAppSettingsDtoFromJSONTyped(json: any, ignoreDiscriminator: boolean): UpdateAppSettingsDto {
    if (json == null) {
        return json;
    }
    return {
...
export function UpdateAppSettingsDtoToJSON(value?: UpdateAppSettingsDto | null, ignoreDiscriminator = false): any {
    if (value == null) {
        return value;
    }
    return {
