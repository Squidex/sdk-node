...
export function CreateSchemaDtoFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateSchemaDto {
    if (json == null) {
        return json;
    }
    return {
...
export function CreateSchemaDtoToJSON(value?: CreateSchemaDto | null, ignoreDiscriminator = false): any {
    if (value == null) {
        return value;
    }
    return {
