...
export function SignalRRuleActionDtoFromJSONTyped(json: any, _ignoreDiscriminator: boolean): SignalRRuleActionDto {
    if (json == null) {
        return json;
    }
    return {
...
export function SignalRRuleActionDtoToJSON(value?: SignalRRuleActionDto | null, _ignoreDiscriminator = false): any {
    if (value == null) {
        return value;
    }
    return {
