...
export function RichTextFieldPropertiesDtoFromJSONTyped(json: any, ignoreDiscriminator: boolean): RichTextFieldPropertiesDto {
    if (json == null) {
        return json;
    }
    return {
...
export function RichTextFieldPropertiesDtoToJSON(value?: RichTextFieldPropertiesDto | null, ignoreDiscriminator = false): any {
    if (value == null) {
        return value;
    }
    return {
