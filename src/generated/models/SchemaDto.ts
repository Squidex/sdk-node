...
export function SchemaDtoFromJSONTyped(json: any, _ignoreDiscriminator: boolean): SchemaDto {
    if (json == null) {
        return json;
    }
    return {
...
export function SchemaDtoToJSON(value?: SchemaDto | null, _ignoreDiscriminator = false): any {
    if (value == null) {
        return value;
    }
    return {
