...
export function RuleElementPropertyDtoFromJSONTyped(json: any, _ignoreDiscriminator: boolean): RuleElementPropertyDto {
    if (json == null) {
        return json;
    }
    return {
...
export function RuleElementPropertyDtoToJSON(value?: RuleElementPropertyDto | null, _ignoreDiscriminator = false): any {
    if (value == null) {
        return value;
    }
    return {
