...
export function SearchResultDtoFromJSONTyped(json: any, _ignoreDiscriminator: boolean): SearchResultDto {
    if (json == null) {
        return json;
    }
    return {
...
export function SearchResultDtoToJSON(value?: SearchResultDto | null, _ignoreDiscriminator = false): any {
    if (value == null) {
        return value;
    }
    return {
