...
export function TranslationDtoFromJSONTyped(json: any, _ignoreDiscriminator: boolean): TranslationDto {
    if (json == null) {
        return json;
    }
    return {
...
export function TranslationDtoToJSON(value?: TranslationDto | null, _ignoreDiscriminator = false): any {
    if (value == null) {
        return value;
    }
    return {
