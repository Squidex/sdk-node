...
import {
    ...
    BooleanFieldEditorFromJSONTyped,
...
export function BooleanFieldPropertiesDtoFromJSONTyped(json: any, ignoreDiscriminator: boolean): BooleanFieldPropertiesDto {
    if (json == null) {
        return json;
    }
    return {
...
export function BooleanFieldPropertiesDtoToJSON(value?: BooleanFieldPropertiesDto | null, ignoreDiscriminator = false): any {
    if (value == null) {
        return value;
    }
    return {
