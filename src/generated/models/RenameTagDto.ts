...
export function RenameTagDtoFromJSONTyped(json: any, _ignoreDiscriminator: boolean): RenameTagDto {
    if (json == null) {
        return json;
    }
    return {
...
export function RenameTagDtoToJSON(value?: RenameTagDto | null, _ignoreDiscriminator = false): any {
    if (value == null) {
        return value;
    }
    return {
