...
export function TagsFieldPropertiesDtoFromJSONTyped(json: any, _ignoreDiscriminator: boolean): TagsFieldPropertiesDto {
    if (json == null) {
        return json;
    }
    return {
...
export function TagsFieldPropertiesDtoToJSON(value?: TagsFieldPropertiesDto | null, _ignoreDiscriminator = false): any {
    if (value == null) {
        return value;
    }
    return {
