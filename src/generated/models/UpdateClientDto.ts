...
export function UpdateClientDtoFromJSONTyped(json: any, _ignoreDiscriminator: boolean): UpdateClientDto {
    if (json == null) {
        return json;
    }
    return {
...
export function UpdateClientDtoToJSON(value?: UpdateClientDto | null, _ignoreDiscriminator = false): any {
    if (value == null) {
        return value;
    }
    return {
