...
export function ResourceFromJSONTyped(json: any, _ignoreDiscriminator: boolean): Resource {
    if (json == null) {
        return json;
    }
    return {
...
export function ResourceToJSON(value?: Resource | null, _ignoreDiscriminator = false): any {
    if (value == null) {
        return value;
    }
    return {
