...
export function JobDtoFromJSONTyped(json: any, _ignoreDiscriminator: boolean): JobDto {
    if (json == null) {
        return json;
    }
    return {
...
export function JobDtoToJSON(value?: JobDto | null, _ignoreDiscriminator = false): any {
    if (value == null) {
        return value;
    }
    return {
