...
export function AppLanguageDtoFromJSONTyped(json: any, _ignoreDiscriminator: boolean): AppLanguageDto {
    if (json == null) {
        return json;
    }
    return {
...
export function AppLanguageDtoToJSON(value?: AppLanguageDto | null, _ignoreDiscriminator = false): any {
    if (value == null) {
        return value;
    }
    return {
