...
export function EmailRuleActionDtoFromJSONTyped(json: any, _ignoreDiscriminator: boolean): EmailRuleActionDto {
    if (json == null) {
        return json;
    }
    return {
...
export function EmailRuleActionDtoToJSON(value?: EmailRuleActionDto | null, _ignoreDiscriminator = false): any {
    if (value == null) {
        return value;
    }
    return {
