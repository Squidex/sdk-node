...
export function DateTimeFieldPropertiesDtoFromJSONTyped(json: any, _ignoreDiscriminator: boolean): DateTimeFieldPropertiesDto {
    if (json == null) {
        return json;
    }
    return {
...
export function DateTimeFieldPropertiesDtoToJSON(value?: DateTimeFieldPropertiesDto | null, _ignoreDiscriminator = false): any {
    if (value == null) {
        return value;
    }
    return {
