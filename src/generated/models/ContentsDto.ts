...
export function ContentsDtoFromJSONTyped(json: any, _ignoreDiscriminator: boolean): ContentsDto {
    if (json == null) {
        return json;
    }
    return {
...
export function ContentsDtoToJSON(value?: ContentsDto | null, _ignoreDiscriminator = false): any {
    if (value == null) {
        return value;
    }
    return {
