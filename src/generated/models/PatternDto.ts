...
export function PatternDtoFromJSONTyped(json: any, _ignoreDiscriminator: boolean): PatternDto {
    if (json == null) {
        return json;
    }
    return {
...
export function PatternDtoToJSON(value?: PatternDto | null, _ignoreDiscriminator = false): any {
    if (value == null) {
        return value;
    }
    return {
