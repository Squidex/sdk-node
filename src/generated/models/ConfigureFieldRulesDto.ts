...
export function ConfigureFieldRulesDtoFromJSONTyped(json: any, ignoreDiscriminator: boolean): ConfigureFieldRulesDto {
    if (json == null) {
        return json;
    }
    return {
...
export function ConfigureFieldRulesDtoToJSON(value?: ConfigureFieldRulesDto | null, ignoreDiscriminator = false): any {
    if (value == null) {
        return value;
    }
    return {
