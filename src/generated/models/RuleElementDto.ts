...
import {
    ...
    RuleElementPropertyDtoFromJSONTyped,
...
export function RuleElementDtoFromJSONTyped(json: any, ignoreDiscriminator: boolean): RuleElementDto {
    if (json == null) {
        return json;
    }
    return {
...
export function RuleElementDtoToJSON(value?: RuleElementDto | null, ignoreDiscriminator = false): any {
    if (value == null) {
        return value;
    }
    return {
