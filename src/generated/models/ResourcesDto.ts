...
export function ResourcesDtoFromJSONTyped(json: any, _ignoreDiscriminator: boolean): ResourcesDto {
    if (json == null) {
        return json;
    }
    return {
...
export function ResourcesDtoToJSON(value?: ResourcesDto | null, _ignoreDiscriminator = false): any {
    if (value == null) {
        return value;
    }
    return {
