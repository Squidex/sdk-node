...
export function LogDownloadDtoFromJSONTyped(json: any, _ignoreDiscriminator: boolean): LogDownloadDto {
    if (json == null) {
        return json;
    }
    return {
...
export function LogDownloadDtoToJSON(value?: LogDownloadDto | null, _ignoreDiscriminator = false): any {
    if (value == null) {
        return value;
    }
    return {
