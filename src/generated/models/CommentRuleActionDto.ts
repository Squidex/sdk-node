...
export function CommentRuleActionDtoFromJSONTyped(json: any, _ignoreDiscriminator: boolean): CommentRuleActionDto {
    if (json == null) {
        return json;
    }
    return {
...
export function CommentRuleActionDtoToJSON(value?: CommentRuleActionDto | null, _ignoreDiscriminator = false): any {
    if (value == null) {
        return value;
    }
    return {
