...
export function UpdateRuleDtoFromJSONTyped(json: any, _ignoreDiscriminator: boolean): UpdateRuleDto {
    if (json == null) {
        return json;
    }
    return {
...
export function UpdateRuleDtoToJSON(value?: UpdateRuleDto | null, _ignoreDiscriminator = false): any {
    if (value == null) {
        return value;
    }
    return {
