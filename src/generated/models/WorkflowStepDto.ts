...
export function WorkflowStepDtoFromJSONTyped(json: any, _ignoreDiscriminator: boolean): WorkflowStepDto {
    if (json == null) {
        return json;
    }
    return {
...
export function WorkflowStepDtoToJSON(value?: WorkflowStepDto | null, _ignoreDiscriminator = false): any {
    if (value == null) {
        return value;
    }
    return {
