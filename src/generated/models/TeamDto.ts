...
export function TeamDtoFromJSONTyped(json: any, _ignoreDiscriminator: boolean): TeamDto {
    if (json == null) {
        return json;
    }
    return {
...
export function TeamDtoToJSON(value?: TeamDto | null, _ignoreDiscriminator = false): any {
    if (value == null) {
        return value;
    }
    return {
