...
export function QueryDtoFromJSONTyped(json: any, _ignoreDiscriminator: boolean): QueryDto {
    if (json == null) {
        return json;
    }
    return {
...
export function QueryDtoToJSON(value?: QueryDto | null, _ignoreDiscriminator = false): any {
    if (value == null) {
        return value;
    }
    return {
