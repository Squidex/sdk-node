...
export function AssignContributorDtoFromJSONTyped(json: any, ignoreDiscriminator: boolean): AssignContributorDto {
    if (json == null) {
        return json;
    }
    return {
...
export function AssignContributorDtoToJSON(value?: AssignContributorDto | null, ignoreDiscriminator = false): any {
    if (value == null) {
        return value;
    }
    return {
