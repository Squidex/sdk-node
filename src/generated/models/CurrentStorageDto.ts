...
export function CurrentStorageDtoFromJSONTyped(json: any, _ignoreDiscriminator: boolean): CurrentStorageDto {
    if (json == null) {
        return json;
    }
    return {
...
export function CurrentStorageDtoToJSON(value?: CurrentStorageDto | null, _ignoreDiscriminator = false): any {
    if (value == null) {
        return value;
    }
    return {
