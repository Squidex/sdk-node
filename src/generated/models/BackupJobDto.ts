...
export function BackupJobDtoFromJSONTyped(json: any, _ignoreDiscriminator: boolean): BackupJobDto {
    if (json == null) {
        return json;
    }
    return {
...
export function BackupJobDtoToJSON(value?: BackupJobDto | null, _ignoreDiscriminator = false): any {
    if (value == null) {
        return value;
    }
    return {
