 ...
 */
export function instanceOfRoleDto(value: any): value is RoleDto {
    if (!value) {
        return false;
    }
...
export function RoleDtoFromJSONTyped(json: any, _ignoreDiscriminator: boolean): RoleDto {
    if (json == null) {
        return json;
    }
    return {
...
export function RoleDtoToJSON(value?: RoleDto | null, _ignoreDiscriminator = false): any {
    if (value == null) {
        return value;
    }
    return {
