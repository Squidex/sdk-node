...
export function ContributorDtoFromJSONTyped(json: any, ignoreDiscriminator: boolean): ContributorDto {
    if (json == null) {
        return json;
    }
    return {
...
export function ContributorDtoToJSON(value?: ContributorDto | null, ignoreDiscriminator = false): any {
    if (value == null) {
        return value;
    }
    return {
