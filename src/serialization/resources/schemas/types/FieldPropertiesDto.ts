...
> = core.serialization
    .union("fieldType", {
        Array: core.serialization
            .lazyObject(async () => (await import("../../..")).ArrayFieldPropertiesDto)
            .extend(_Base),
        Assets: core.serialization
            .lazyObject(async () => (await import("../../..")).AssetsFieldPropertiesDto)
            .extend(_Base),
        ...
        Geolocation: core.serialization
            ...
            .extend(_Base),
        Json: core.serialization
            .lazyObject(async () => (await import("../../..")).JsonFieldPropertiesDto)
            .extend(_Base),
        Number: core.serialization
            .lazyObject(async () => (await import("../../..")).NumberFieldPropertiesDto)
            .extend(_Base),
        References: core.serialization
            .lazyObject(async () => (await import("../../..")).ReferencesFieldPropertiesDto)
            .extend(_Base),
        String: core.serialization
            .lazyObject(async () => (await import("../../..")).StringFieldPropertiesDto)
            .extend(_Base),
        Tags: core.serialization
            .lazyObject(async () => (await import("../../..")).TagsFieldPropertiesDto)
            .extend(_Base),
